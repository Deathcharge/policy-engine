...
Thank you for your interest in contributing to policy-engine! This document provides guidelines and instructions for contributing to the project.
...
1. **Fork the repository**
   ```bash
   # Go to https://github.com/Deathcharge/policy-engine
   # Click "Fork" button
   ```

2. **Clone your fork**
   ```bash
   git clone https://github.com/YOUR_USERNAME/policy-engine.git
   cd policy-engine
   ```

3. **Add upstream remote**
   ```bash
   git remote add upstream https://github.com/Deathcharge/policy-engine.git
   ```
...
- **Questions**: Use [GitHub Discussions](https://github.com/Deathcharge/policy-engine/discussions)
- **Issues**: Use [GitHub Issues](https://github.com/Deathcharge/policy-engine/issues)
