...
class ToolExecutor:
    ...
    async def execute_parallel(self, tools: list, ucf_context: UCFMetrics | None = None) -> dict[str, dict[str, Any]]:
        """
        ...
        for (tool_name, _, _), result in zip(tools, results_list, strict=False):
