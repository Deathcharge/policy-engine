...
class ToolUsageStats(TypedDict):
    """Usage statistics tracked for each registered tool."""
...
class ToolRegistry:
    ...
    async def execute_tool(self, name: str, *args, **kwargs) -> dict:
        ...
        try:
            ...
            return {"success": False, "error": type(e).__name__, "tool": name}

    async def get_usage_stats(self, name: str) -> ToolUsageStats | None:
        """
    ...
    async def get_all_usage_stats(self) -> dict[str, ToolUsageStats]:
        """
